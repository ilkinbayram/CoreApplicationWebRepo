...
namespace Business.Concrete
{
    public class TeacherManager : ITeacherService
    {
        ...
        public IDataResult<IEnumerable<Teacher>> GetList(Expression<Func<Teacher, bool>> filter = null)
        {
            try
            {
                var response = _TeacherDal.GetList(filter);
                var mappingResult = _mapper.Map<IEnumerable<Teacher>>(response);
                return new SuccessDataResult<IEnumerable<Teacher>>(mappingResult);
            }
            catch (Exception exception)
            {
                return new ErrorDataResult<IEnumerable<Teacher>>(null, $"Exception Message: { $"Exception Message: {exception.Message} \nInner Exception: {exception.InnerException}"} \nInner Exception: {exception.InnerException}");
            }
        }
        ...
        public IDataResult<int> AddList(IEnumerable<Teacher> Teachers)
        {
            try
            {
        ...
        public IDataResult<int> UpdateList(IEnumerable<Teacher> Teachers)
        {
            try
            {
        ...
        public IDataResult<int> DeletePermanentlyList(IEnumerable<Teacher> Teachers)
        {
            try
            {
        ...
        public IDataResult<int> DeleteByStatusList(IEnumerable<Teacher> Teachers)
        {
            try
            {
        ...
        private void DeleteAllEntitiesByStatusForAllRelationList(IEnumerable<Teacher> Teachers)
        {
            foreach (var Teacher in Teachers)
            {
            }
