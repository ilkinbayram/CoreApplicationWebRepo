...
namespace Business.Concrete
{
    public class CourseManager : ICourseService
    {
        ...
        public IDataResult<IEnumerable<Course>> GetList(Expression<Func<Course, bool>> filter = null)
        {
            try
            {
                var response = _courseDal.GetList(filter);
                var mappingResult = _mapper.Map<IEnumerable<Course>>(response);
                return new SuccessDataResult<IEnumerable<Course>>(mappingResult);
            }
            catch (Exception exception)
            {
                return new ErrorDataResult<IEnumerable<Course>>(null, $"Exception Message: { $"Exception Message: {exception.Message} \nInner Exception: {exception.InnerException}"} \nInner Exception: {exception.InnerException}");
            }
        }
        ...
        public IDataResult<int> AddList(IEnumerable<Course> courses)
        {
            try
            {
        ...
        public IDataResult<int> UpdateList(IEnumerable<Course> courses)
        {
            try
            {
        ...
        public IDataResult<int> DeletePermanentlyList(IEnumerable<Course> courses)
        {
            try
            {
        ...
        public IDataResult<int> DeleteByStatusList(IEnumerable<Course> courses)
        {
            try
            {
        ...
        private void DeleteAllEntitiesByStatusForAllRelationList(IEnumerable<Course> courses)
        {
            foreach (var course in courses)
            {
            }
