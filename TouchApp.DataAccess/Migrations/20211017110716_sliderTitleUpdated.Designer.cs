...
namespace TouchApp.DataAccess.Migrations
{
    ...
    [Migration("20211017110716_sliderTitleUpdated")]
    partial class sliderTitleUpdated
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Blog", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("53aa9663-6e80-4b8e-b918-1de636e9302e");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Course", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 15, 7, 14, 440, DateTimeKind.Local).AddTicks(8101));
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("cca29ca4-aebb-4697-9b6e-11b85d042f78");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Tag", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 15, 7, 14, 476, DateTimeKind.Local).AddTicks(6850));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.TagBlog", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 15, 7, 14, 478, DateTimeKind.Local).AddTicks(5723));
                    ...
                    b.Property<DateTime?>("Modified_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 15, 7, 14, 478, DateTimeKind.Local).AddTicks(6589));
