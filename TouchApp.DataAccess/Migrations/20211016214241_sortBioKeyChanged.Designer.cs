...
namespace TouchApp.DataAccess.Migrations
{
    ...
    [Migration("20211016214241_sortBioKeyChanged")]
    partial class sortBioKeyChanged
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Blog", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("5554c428-da8e-49b9-889d-fdf11fc29859");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Course", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("d6eed483-8394-4d38-87b1-eb0a5d122cf4");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Tag", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 1, 42, 40, 29, DateTimeKind.Local).AddTicks(3447));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.TagBlog", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 1, 42, 40, 32, DateTimeKind.Local).AddTicks(3779));
                    ...
                    b.Property<DateTime?>("Modified_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 1, 42, 40, 32, DateTimeKind.Local).AddTicks(5106));
