...
namespace TouchApp.DataAccess.Migrations
{
    ...
    [Migration("20211017030414_modelCourseChanged")]
    partial class modelCourseChanged
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Blog", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("e0ad5e86-d411-4734-8702-6f46f1e7252d");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Course", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("08b035c1-6304-4baf-928d-2f0aaed64e9b");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Tag", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 7, 4, 12, 378, DateTimeKind.Local).AddTicks(9277));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.TagBlog", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 7, 4, 12, 381, DateTimeKind.Local).AddTicks(2375));
                    ...
                    b.Property<DateTime?>("Modified_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 17, 7, 4, 12, 381, DateTimeKind.Local).AddTicks(3030));
