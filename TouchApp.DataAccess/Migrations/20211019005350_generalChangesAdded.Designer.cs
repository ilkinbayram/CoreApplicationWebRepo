...
namespace TouchApp.DataAccess.Migrations
{
    ...
    [Migration("20211019005350_generalChangesAdded")]
    partial class generalChangesAdded
    {
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Blog", b =>
                {
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("c014b7d2-6b0f-4795-b6f5-936971afca44");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Course", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 4, 53, 47, 655, DateTimeKind.Local).AddTicks(921));
                    ...
                    b.Property<string>("UniqueToken")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("nvarchar(max)")
                        .HasDefaultValue("edf29543-b901-471b-b83d-baa0ca6c0665");
            ...
            modelBuilder.Entity("Core.Entities.Concrete.Tag", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 4, 53, 47, 677, DateTimeKind.Local).AddTicks(4945));
            ...
            modelBuilder.Entity("Core.Entities.Concrete.TagBlog", b =>
                {
                    ...
                    b.Property<DateTime?>("Created_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 4, 53, 47, 678, DateTimeKind.Local).AddTicks(8496));
                    ...
                    b.Property<DateTime?>("Modified_at")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("smalldatetime")
                        .HasDefaultValue(new DateTime(2021, 10, 19, 4, 53, 47, 678, DateTimeKind.Local).AddTicks(9095));
