...
{
    class AnswerVariationConfiguration : IEntityTypeConfiguration<AnswerVariation>
    {
        public void Configure(EntityTypeBuilder<AnswerVariation> builder)
        {
            builder.ToTable("AnswerVariations");
