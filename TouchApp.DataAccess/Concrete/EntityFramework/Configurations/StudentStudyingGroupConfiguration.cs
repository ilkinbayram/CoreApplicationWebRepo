...
{
    class StudentStudyingGroupConfiguration : IEntityTypeConfiguration<StudentStudyingGroup>
    {
        public void Configure(EntityTypeBuilder<StudentStudyingGroup> builder)
        {
            builder.ToTable("StudentStudyingGroups");
