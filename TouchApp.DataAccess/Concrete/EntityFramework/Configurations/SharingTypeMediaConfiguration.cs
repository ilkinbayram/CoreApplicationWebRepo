...
{
    class SharingTypeMediaConfiguration : IEntityTypeConfiguration<SharingTypeMedia>
    {
        public void Configure(EntityTypeBuilder<SharingTypeMedia> builder)
        {
            builder.ToTable("SharingTypeMedias");
