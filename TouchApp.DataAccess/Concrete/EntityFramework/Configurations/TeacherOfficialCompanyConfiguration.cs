...
{
    public class TeacherOfficialCompanyConfiguration : IEntityTypeConfiguration<TeacherOfficialCompany>
    {
        public void Configure(EntityTypeBuilder<TeacherOfficialCompany> builder)
        {
            builder.ToTable("TeacherOfficialCompanies");
