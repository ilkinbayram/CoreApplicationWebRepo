...
{
    class SharingTypePostConfiguration : IEntityTypeConfiguration<SharingTypePost>
    {
        public void Configure(EntityTypeBuilder<SharingTypePost> builder)
        {
            builder.ToTable("SharingTypePosts");
