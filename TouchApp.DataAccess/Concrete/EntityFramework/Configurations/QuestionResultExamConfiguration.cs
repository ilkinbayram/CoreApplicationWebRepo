...
{
    class QuestionResultExamConfiguration : IEntityTypeConfiguration<QuestionResultExam>
    {
        public void Configure(EntityTypeBuilder<QuestionResultExam> builder)
        {
            builder.ToTable("QuestionResultExams");
