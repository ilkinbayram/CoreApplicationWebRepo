...
{
    class StudyingGroupConfiguration : IEntityTypeConfiguration<StudyingGroup>
    {
        public void Configure(EntityTypeBuilder<StudyingGroup> builder)
        {
            builder.ToTable("StudyingGroups");
            ...
            builder.HasMany(p => p.StudentStudyingGroups).WithOne(x => x.StudyingGroup).OnDelete(DeleteBehavior.Cascade).IsRequired(false);
